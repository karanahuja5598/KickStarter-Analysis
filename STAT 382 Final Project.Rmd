...
# dataFinal$pledged<- as.integer(dataFinal$pledged)
# dataFinal$goal<- as.integer(dataFinal$goal)
...
```{r scatter plots}
# TODO: FIX ALL THESE BY CATEGORY
...
# Fix this one
plot(dataFinal$id, dataFinal$pReached, xlab = "gfdgfdgfd ", ylab = "gfdgfdgdfgd", main = "Category vs % Raised", col = "goldenrod1")
...
cor(dataFinal$id, dataFinal$pReached)
