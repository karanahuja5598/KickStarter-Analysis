...
anova3 <- aov(category~pledged, data = dataFinal)

summary(anova3)

anova4 <- aov(category~pReached, data = dataFinal)

summary(anova4)

anova5 <- aov(category~backers_count+goal+pledged+pReached, data = dataFinal)
