...
#### The review of similar project: [source](https://towardsdatascience.com/predicting-the-success-of-kickstarter-campaigns-3f4a976419b9) These observations can be found on the project writeup under Literature Review.
...
> Varialbles we want to focus on and analyze:
- (1) backers_count
...
#TODO: Print tables out into html
```{r summary}
