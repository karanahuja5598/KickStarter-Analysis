...
# David : working on this currently. Going to categorize the data by (category)
...
barplot(table(dataFinal$category),col= rainbow(5),las = 2,cex.names = .25,horiz = FALSE,ylim=c(0,140),beside=TRUE, xpd = FALSE, width = 141)

title(xlab="", line=4, cex.lab=1)
mtext(text="Categories popularity", side=1, line=6.5)
...
plot(dataFinal$id, dataFinal$goal, xlab = "Category", ylab = "Goal", main = "Category vs Goal", col = "deepskyblue3")

plot(dataFinal$id, dataFinal$pledged, xlab = "Category", ylab = "Pledged", main = "Category vs Pledged", col = "deepskyblue3")

plot(dataFinal$id, dataFinal$usd_pledged, xlab = "Category", ylab = "USD Pledged", main = "Category vs USD Pledged", col = "deepskyblue3")
