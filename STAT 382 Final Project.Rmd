...
cor(dataFinal$category, dataFinal$backers_count)

cor(dataFinal$category, dataFinal$goal)

cor(dataFinal$category, dataFinal$pledged)

cor(dataFinal$category, dataFinal$usd_pledged)
