...
par(mfrow = c(1, 2))
boxplot(dataFinal$backers_count,ylim=c(0,500),xlab="Partial 0-500 boxplot")
...
par(mfrow = c(1, 2))
boxplot(dataFinal$goal,ylim=c(0,30000),xlab="Partial 0-30000 boxplot")
...
par(mfrow = c(1, 2))
boxplot(dataFinal$pledged,ylim=c(0,20000),xlab="Partial 0-20000 boxplot")
...
par(mfrow = c(1, 2))
boxplot(dataFinal$pReached,ylim=c(0,400),xlab="Partial 0-400 boxplot")
...
#Creates a 1 x 4 picture of the graphs
