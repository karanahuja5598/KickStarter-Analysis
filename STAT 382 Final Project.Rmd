...
sort(boxplot.stats(dataFinal$backers_count)$out)
IQR(dataFinal$backers_count)


boxplot(dataFinal$backers_count,ylim=c(0,2000))

median(sort(boxplot.stats(dataFinal$backers_count)$out))
mean(sort(boxplot.stats(dataFinal$backers_count)$out))

dataFinal<-dataFinal[dataFinal$goal > 100,]
boxplot(dataFinal$backers_count,ylim=c(0,2000))
